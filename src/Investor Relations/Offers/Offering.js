...
export const Offering = () => {
    const text =[
        ...
        {usrc:j,heading:"B2B SUPPLIES",para:"Hyperpure is a B2B platform supplying high quality food ingredients and other products. One can order our products anywhere and anytime",ucount:"617",lcount:"8",avg:"# of cities present in",del:"Hyperpure revenue"}
    ];
    const qtext = [
